...
CREATE TABLE IF NOT EXISTS `Toppick_Schema`.`MenuDia` (
  `Producto_idProducto` INT NOT NULL,
  `sopa` VARCHAR(45) NULL,
  `proteico` VARCHAR(45) NULL,
  `proteicoOpcional` VARCHAR(45) NULL,
  `energetico` VARCHAR(45) NULL,
  `cereal` VARCHAR(45) NULL,
  `verdura` VARCHAR(45) NULL,
  `verduraCaliente` VARCHAR(45) NULL,
