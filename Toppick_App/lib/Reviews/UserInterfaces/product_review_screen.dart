...
import 'package:Toppick_App/Reviews/UserInterfaces/create_product_review_screen.dart';
...
class ProductReviewScreen extends StatelessWidget {
  ProductReviewScreen(this.product, this.imagePath, this.prefs);
  ...
  Widget build(BuildContext context) {
    this.reviews = [];
    var createReview=(){
      Navigator.push(context, MaterialPageRoute(builder: (context) => CreateProductReviewScreen(this.prefs, this.product)));
    };
    return Scaffold(
      body: Stack(
            ...
            Align(
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    Center(
                      child: Text(this.product.name, style: TextStyle(color: Color(0xFFD76060), fontSize: 40, fontWeight: FontWeight.bold))
                    ),
                    Text("Descripción", style: TextStyle(color: Color(0xFFD76060), fontSize: 30, fontWeight: FontWeight.bold)),
                    Container(
                      padding: const EdgeInsets.only(top: 10.0, bottom: 5.0),
                      child: Text(this.product.description, style: TextStyle(fontWeight: FontWeight.w400,fontSize: 15, color: Color(0xFF707070)),)
                    ),
                    Text("Reseñas", style: TextStyle(color: Color(0xFFD76060), fontSize: 30, fontWeight: FontWeight.bold)),
                    SizedBox(
                      height: 180,
                      child: FutureBuilder(
                        future: this.controller.getProductReviews(this.prefs.getString('cookie'), this.product.id),
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: RatingBar.builder(
                            initialRating: this.product.score,
