  ...
  Widget build(BuildContext context) {
    ...
    void check(){
      if(formKey.currentState!.validate()){
        ...
        int identifier = (phone)?this.metodo.numeroCelular:this.metodo.numeroCuenta;
        this.controller.updatePaymentMethod(this.prefs.getString('cookie'), this.name, identifier, int.parse(this.toAdd), this.metodo.availableAmount).then(
          (value) {
            if(value){
